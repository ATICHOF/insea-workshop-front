...
const Newvid = () => {
  return (
    <div className='newvid'>
        ...
        <a href='/home' className='close' ><img alt='close' src={require('../assets/icons/Close.png')}/></a>
        <div className='title'>
            ...
            <div className='thumb'>
                ...
                <img alt='frame' className='thumbimage' src={require("../assets/images/Frame 850.png")}/>
            </div>
        </div>
